...
class Validator:
    ...
    Expected shape for the initial migration contract::

        data_dir/
          profiles.json
          raw/**/*.json

    The layout is intentionally independent of FreeCAD. Future fitting and
    hardware validators can extend this class without changing consumers.
    """
